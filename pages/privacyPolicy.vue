  ...
  <div class="sm:mx-16 mx-2 mt-6">
    ...
    <v-row>
      <v-col cols="12">
        ...
        <div
          style="height: 50px"
          class="hr hr-invisible avia-builder-el-1 el_after_av_heading el_before_av_textblock"
        >
        ...
        <p>
          ...
          wir keinen anderen rechtlich zulässigen&nbsp; Gründe für die
